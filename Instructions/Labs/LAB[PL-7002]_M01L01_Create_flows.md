...
1. Entrez `location` dans le champ de recherche.
...
1. Sélectionnez **Développer la condition**.
...
1. Sous **Automatisons quelque chose. Quels résultats souhaitez-vous obtenir ?**, entrez `Every day send me an email with the daily summary from MSN Weather`.
...
1. Sélectionnez le **X** pour effacer les **Unités** et, dans la liste déroulante, sélectionnez **Impérial**.
...
1. Sélectionnez le champ **Texte de notification** et sélectionnez l’icône de contenu dynamique.
